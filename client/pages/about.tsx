...
<div className="pl-12 sm:pl-16 md:pl-20 lg:pl-28 
    ...
    &nbsp;&nbsp;&nbsp;he first time I understood the word 'passion' was solving <span className="font-nokia inline-block"> math </span> in primary school and that fire found its <span className="font-avant inline-block">kindling</span> when I started using a desktop. Since then, I have loved all things tech! I also come from a place with <span className="font-groovy inline-block">extremely</span> rich architectures, art and maximalism; So naturally, I’ve always been interested in <span className="font-pinyon inline-block">design</span> and it comes out in some shape or form in everything I do (whether it is <span className="font-mess inline-block">decorating</span> my dorm or it is designing a presentation when we’re only getting marked on how we speak or photographing my friends). And as cheesy as it may sound, <span className="font-bohme inline-block">Programming</span> gave me a way to understand the world and with design, I found a way to add colors in it.               </p>
...
Other interests of mine include <span className="font-narnia inline-block">cooking</span> (especially pasta), painting, singing (offkey), dancing and my favorite thing in the world:  talking -- with anyone and everyone.              </p>
            </div>
          </div>
        </div>
      </main>
...
<div className="max-w-7xl mx-auto mt-16 sm:mt-20 lg:mt-32 flex justify-center">
          ...
          >
            {/* Card Background */}
            <div className="absolute inset-0 bg-white rounded-lg shadow-lg border border-black/5  overflow-hidden">
            </div>
            ...
            {/* Decorative line */}
            <svg
  className="absolute left-[21%] top-[10%] w-[70%] max-w-[537px]"
  viewBox="0 0 537 97"
